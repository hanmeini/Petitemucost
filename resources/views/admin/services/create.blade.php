        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-100 rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden">
                ...
                <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Isi detail layanan makeup baru yang ingin Anda tawarkan.</p>
                </div>
                    ...
                    <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}"
                                   ...
                                   placeholder="Contoh: Makeup Wisuda Natural" required autofocus>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="dp_percentage" id="dp_percentage" value="{{ old('dp_percentage', 50) }}" min="0" max="100"
                                           class="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 transition-all outline-none shadow-sm"
                                           required>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5"
                                      ...
                                      placeholder="Jelaskan detail layanan, apa saja yang didapat, dll." required>{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="pt-8 border-t border-gray-100 flex items-center justify-end gap-4">
                            ...
                            <button type="submit" class="px-8 py-3 bg-pink-600 hover:bg-pink-700 text-white text-sm font-bold rounded-full shadow-lg shadow-pink-500/30 transition-all hover:-translate-y-0.5">
                                Simpan Layanan
                            </button>
                        </div>
                    </form>
